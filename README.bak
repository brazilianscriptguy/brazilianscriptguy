...
An **enterprise-grade, research-aligned automation platform** for Windows Server and Windows 10/11 environments, organized into eight specialized modules:
...
> 💡 Every release includes NuGet packaging, automated changelog generation, and SHA256 integrity validation.
...
[![PS SARIF](https://img.shields.io/badge/SARIF-PowerShell-brightgreen?style=for-the-badge&logo=github)](https://github.com/brazilianscriptguy/Windows-SysAdmin-ProSuite/security/code-scanning)

#### 📜 VBScript Quality

[![VBScript CI](https://img.shields.io/github/actions/workflow/status/brazilianscriptguy/Windows-SysAdmin-ProSuite/vbscript-syntax-validation.yml?branch=main&style=for-the-badge&label=VBS%20CI&logo=windows)](https://github.com/brazilianscriptguy/Windows-SysAdmin-ProSuite/actions/workflows/vbscript-syntax-validation.yml)
[![VBS SARIF](https://img.shields.io/badge/SARIF-VBScript-brightgreen?style=for-the-badge&logo=github)](https://github.com/brazilianscriptguy/Windows-SysAdmin-ProSuite/security/code-scanning)
...
[![Secrets SARIF](https://img.shields.io/badge/SARIF-Secrets-brightgreen?style=for-the-badge&logo=github)](https://github.com/brazilianscriptguy/Windows-SysAdmin-ProSuite/security/code-scanning)

---

## 📚 Research & Publications

The following works form the **academic and methodological foundation** behind Windows-SysAdmin-ProSuite — grounding its engineering principles in peer-reviewed science.
...
*Revista FT — Computer Science*, Vol. 29, Issue 142, January 2025 · **Qualis B2** · ISSN: 1678-0817

> Proposes a structured SQL-based approach to Windows Event Log (EVTX) analysis, supporting incident investigation, auditing, and Active Directory authentication tracing.
...
Sorian, 1st ed., 2024 · Print ISBN: 978-65-5453-346-1 · eBook ISBN: 978-65-5453-366-9

> A practitioner-focused scholarly work on event log auditing, forensic readiness, and vulnerability identification — using Syslog concepts and PowerShell-enabled workflows. For information security professionals, auditors, and DFIR practitioners.
...
> Focused on applying Group Policy Objects (GPOs) to harden Windows domain environments, with emphasis on centralized policy enforcement and enterprise security baselines.
...
> Defines a structured methodology for log auditing and forensic analysis, applying Syslog principles and PowerShell-driven analysis for security monitoring and governance.
...
[![ORCID](https://img.shields.io/badge/ORCID-0000--0003--3705--7468-A6CE39?style=for-the-badge&logo=orcid)](https://orcid.org/0000-0003-3705-7468)
[![Lattes CV](https://img.shields.io/badge/Lattes%20CV-CNPq-00A693?style=for-the-badge&logo=academia)](http://lattes.cnpq.br/0191525072495482)
...
![ITSM Automation](https://img.shields.io/badge/ITSM%20Automation-WKS%20%26%20SVR%20Provisioning-27AE60?style=for-the-badge&logo=windows)
...
**Core Expertise:** PowerShell automation · Windows Server · Active Directory · DNS · DHCP · WSUS · GPO · PKI · certificate management · IAM · ITSM provisioning · security hardening · credential hygiene · digital forensics · DFIR · EVTX log analysis · event correlation · incident response · CI/CD · GitHub Actions · PSScriptAnalyzer · Prettier · EditorConfig · NuGet · SHA256 · SARIF · CodeQL · secure DevOps · modular architecture · enterprise scripting · Windows infrastructure automation

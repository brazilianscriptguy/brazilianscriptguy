...
### 🧩 Repo-local Cards (Generated by GitHub Actions)
![GitHub Stats (Repo-local)](https://raw.githubusercontent.com/brazilianscriptguy/Windows-SysAdmin-ProSuite/main/assets/readme-cards/github-stats.svg)
![Contribution Streak (Repo-local)](https://raw.githubusercontent.com/brazilianscriptguy/Windows-SysAdmin-ProSuite/main/assets/readme-cards/streak.svg)
...
> **Legend**  
> • **Repo-local Cards** → generated by `.github/scripts/generate_readme_cards.py` and committed under `assets/readme-cards/`  
> • **Total Code Languages** → aggregated bytes across non-fork repos (GraphQL language `size`)  
> • **Top Languages by Commit** → languages with highest commit activity (external card service)
